! function(a) {
    ...
    t.prototype._reset = function() { this.body.removeAttr("data-leftbar-theme") }, t.prototype.activateCondensedSidebar = function() { this.body.attr("data-leftbar-compact-mode", "condensed") }, t.prototype.deactivateCondensedSidebar = function() { this.body.removeAttr("data-leftbar-compact-mode") }, t.prototype.activateScrollableSidebar = function() { this.body.attr("data-leftbar-compact-mode", "scrollable") }, t.prototype.deactivateScrollableSidebar = function() { this.body.removeAttr("data-leftbar-compact-mode") }, t.prototype.activateDefaultTheme = function() { this._reset() }, t.prototype.activateLightTheme = function() { this._reset(), this.body.attr("data-leftbar-theme", "light") }, t.prototype.activateDarkTheme = function() { this._reset(), this.body.attr("data-leftbar-theme", "dark") }, t.prototype.initMenu = function() {
        var e = this;
        this._reset(), a(".side-nav").metisMenu(), a(document).on("click", ".button-menu-mobile", function(t) { t.preventDefault(), e.body.toggleClass("sidebar-enable") }), a(".side-nav a").each(function() {
    ...
    }, t.prototype.init = function() { this.initMenu() }, a.LeftSidebar = new t, a.LeftSidebar.Constructor = t
}(window.jQuery),
function(a) {
    "use strict";
    ...
    t.prototype.initMenu = function() {
        ...
        }), a(".navbar-toggle").on("click", function() { a(this).toggleClass("open"), a("#navigation").slideToggle(400) }))
    ...
    }, t.prototype.init = function() { this.initMenu(), this.initSearch() }, a.Topbar = new t, a.Topbar.Constructor = t
}(window.jQuery),
function(a) {
    "use strict";
    ...
    t.prototype._selectOptionsFromConfig = function() {
    ...
    }, t.prototype.toggleRightSideBar = function() { this.body.toggleClass("right-bar-enabled"), this._selectOptionsFromConfig() }, t.prototype.init = function() {
        var e = this;
        a(document).on("click", ".right-bar-toggle", function() { e.toggleRightSideBar() }), a(document).on("click", "body", function(t) { 0 < a(t.target).closest(".right-bar-toggle, .right-bar").length || 0 < a(t.target).closest(".left-side-menu, .side-nav").length || a(t.target).hasClass("button-menu-mobile") || 0 < a(t.target).closest(".button-menu-mobile").length || (a("body").removeClass("right-bar-enabled"), a("body").removeClass("sidebar-enable")) }), a("input[type=radio][name=width]").change(function() {
            switch (a(this).val()) {
                case "fluid":
                    a.App.activateFluid();
                    break;
        ...
        }), a("#resetBtn").on("click", function(t) { t.preventDefault(), a.App.resetLayout(function() { e._selectOptionsFromConfig() }) })
    }, a.RightBar = new t, a.RightBar.Constructor = t
}(window.jQuery),
function(a) {
    "use strict";

    function t() { this.body = a("body"), this.window = a(window), this._config = {}, this.defaultSelectedStyle = null }
    var e = "default",
        i = "light",
        o = "dark",
        n = { sideBarTheme: e, isBoxed: !1, isCondensed: !1, isScrollable: !1, isDarkModeEnabled: !1 };
    t.prototype._saveConfig = function(t) { a.extend(this._config, t) }, t.prototype._getStoredConfig = function() {
        ...
        var e = this;
        a("#main-style-container").length && (e.defaultSelectedStyle = a("#main-style-container").attr("href")), this._applyConfig(), this._adjustLayout(), this.window.on("resize", function(t) { t.preventDefault(), e._adjustLayout() }), a.Topbar.init()
...
function(o) {
    ...
    t.prototype.init = function() {
        ...
        o(document).on("click", this.$portletCloser, function(t) {
            ...
            setTimeout(function() { a.fadeOut("fast", function() { a.remove() }) }, 500 + 5 * Math.random() * 300)
        })
...
function(n) {
    ...
    t.prototype.initSelect2 = function() { n('[data-toggle="select2"]').select2() }, t.prototype.initMask = function() {
        ...
        var o = { startDate: moment().subtract(29, "days"), endDate: moment(), ranges: { Today: [moment(), moment()], Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")], "Last 7 Days": [moment().subtract(6, "days"), moment()], "Last 30 Days": [moment().subtract(29, "days"), moment()], "This Month": [moment().startOf("month"), moment().endOf("month")], "Last Month": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")] } };
        n('[data-toggle="date-picker-range"]').each(function(t, e) {
            var a = n.extend({}, o, n(e).data()),
                i = a.targetDisplay;
            n(e).daterangepicker(a, function(t, e) { i && n(i).html(t.format("DD/MM/YYYY") + " - " + e.format("DD/MM/YYYY")) })
        })
    ...
    }, t.prototype.init = function() { this.initSelect2(), this.initMask(), this.initDateRange(), this.initTimePicker(), this.initTouchspin(), this.initMaxlength() }, n.AdvanceFormApp = new t, n.AdvanceFormApp.Constructor = t
}(window.jQuery),
function(c) {
    "use strict";
...
function(e) {
    ...
    t.prototype.activateDefaultSidebarTheme = function() { e.LayoutThemeApp.activateDefaultSidebarTheme() }, t.prototype.activateLightSidebarTheme = function() { e.LayoutThemeApp.activateLightSidebarTheme() }, t.prototype.activateDarkSidebarTheme = function() { e.LayoutThemeApp.activateDarkSidebarTheme() }, t.prototype.activateCondensedSidebar = function() { e.LayoutThemeApp.activateCondensedSidebar() }, t.prototype.deactivateCondensedSidebar = function() { e.LayoutThemeApp.deactivateCondensedSidebar() }, t.prototype.activateScrollableSidebar = function() { e.LayoutThemeApp.activateScrollableSidebar() }, t.prototype.deactivateScrollableSidebar = function() { e.LayoutThemeApp.deactivateScrollableSidebar() }, t.prototype.activateBoxed = function() { e.LayoutThemeApp.activateBoxed() }, t.prototype.activateFluid = function() { e.LayoutThemeApp.activateFluid() }, t.prototype.activateDarkMode = function() { e.LayoutThemeApp.activateDarkMode() }, t.prototype.deactivateDarkMode = function() { e.LayoutThemeApp.deactivateDarkMode() }, t.prototype.clearSavedConfig = function() { e.LayoutThemeApp.clearSavedConfig() }, t.prototype.getLayoutConfig = function() { return e.LayoutThemeApp.getConfig() }, t.prototype.resetLayout = function(t) { e.LayoutThemeApp.reset(t) }, t.prototype.init = function() {
        ...
        e.Portlet.init(), e.AdvanceFormApp.init(), e.Components.init(), e(window).on("load", function() { e("#status").fadeOut(), e("#preloader").delay(350).fadeOut("slow") })
